...
import * as dateSelect from '../../signup/date-select.js';
...
vi.mock('../../signup/period-select.js', () => ({ setupPeriodOptionsObserver: vi.fn(), setupPeriodValueObserver: vi.fn(), periodChangeHandler: vi.fn() }));
vi.mock('../../signup/type-input.js', () => ({ setupTypeInputObserver: vi.fn(), toggleInterventionsLink: vi.fn(), toggleTutoringLink: vi.fn(), typeChangeHandler: vi.fn() }));
vi.mock('../../signup/panels.js', () => ({ setupPanelsObserver: vi.fn() }));
vi.mock('../../signup/glass-rooms-input.js', () => ({ setupGlassRoomsObserver: vi.fn() }));
vi.mock('../../signup/study-select.js', () => ({ setupStudyOptionsObserver: vi.fn(), setupStudySelectValueObserver: vi.fn(), studyTeacherChangeHandler: vi.fn() }));
vi.mock('../../signup/subject-select.js', () => ({ setupSubjectOptionsObserver: vi.fn(), setupSubjectValueObserver: vi.fn(), subjectChangeHandler: vi.fn() }));
vi.mock('../../signup/interventions-teacher-select.js', () => ({ setupInterventionTeacherObserver: vi.fn() }));
vi.mock('../../signup/student-input.js', () => ({ setupStudentInputObserver: vi.fn(), studentInputChangeHandler: vi.fn() }));
vi.mock('../../signup/schedule-rules.js', () => ({ setupScheduleRulesObserver: vi.fn() }));
vi.mock('../../signup/capacity-validation.js', () => ({ setupCapacityValidationObserver: vi.fn() }));
vi.mock('../../signup/form-data.js', () => ({ preventFormSubmit: vi.fn(), submitForm: vi.fn(), startOver: vi.fn() }));
vi.mock('../../common/dates.js', () => ({ toDateInputValue: vi.fn(() => '2023-10-01') }));
vi.mock('../../common/debug.js', () => ({ DEBUG: false }));
