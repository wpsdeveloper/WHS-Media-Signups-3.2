...
describe('Study Select Module', () => {
  ...
  describe('updateStudyOptions', () => {
    ...
    it('should append "Directly from class" if the DOM type input is "Alt setting"', () => {
      ...
      expect(dom.appendOption).toHaveBeenCalledWith('#study-teacher-select', 'Directly from class', 'Directly from class');
      expect(dom.setAttribute).toHaveBeenCalledWith('#study-teacher-select #from-class', 'selected', true);
    });
  ...
  describe('showStudyAltInput', () => {
    it('should show text input when studyTeachers has a length of 0', () => {
    ...
    it('should show select dropdown when studyTeachers has a length > 0', () => {
      dom.qsa.mockReturnValue([ { value: 'Mr. Smith' } ]);
      showStudyAltInput();
