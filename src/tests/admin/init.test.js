...
import { initObservers, initializeApp, initializeUi, setTooltips } from '../../client/admin/init.js';
...
import * as dataTable from '../../client/admin/data-table.js';
import * as settingsTable from '../../client/admin/settings-table.js';
import * as data from '../../client/admin/data.js';
import * as studentInput from '../../client/common/student-input.js';
...
vi.mock('../../client/admin/settings-table.js', () => ({
  initObservers: vi.fn(),
}));

vi.mock('../../client/admin/data.js', () => ({
  setupAuditObserver: vi.fn(),
  getAuditHandler: vi.fn(),
}));

vi.mock('../../client/common/student-input.js', () => ({
